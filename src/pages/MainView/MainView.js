...
function MainView() {
    ...
    return (
        <Form>
            ...
            <button data-test="login-btn" type='submit' onClick={(e) => sendLogin(e)}>{sentRequest ? <ThreeDots height="18" width="30" color="white" ariaLabel="loading" wrapperStyle={{}} wrapperClassName=""/> : "LogIn" }</button>
